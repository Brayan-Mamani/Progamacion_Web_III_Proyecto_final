...
import { Home, User, LogOut,FileChartColumn,Store } from 'lucide-react';
...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const menuItems = [
    { id: 'inicio', path: '/inicio', icon: Home, label: 'inicio' },
    { id: 'curso', path: '/curso', icon: Store, label: 'curso'},
    { id: 'estudiante', path: '/estudiante', icon: User, label: 'estudiante'},
    { id: 'reporte', path: '/reporte', icon: FileChartColumn, label: 'reporte'}
  ];
